...
public class Room {
	...
	public Room() {
		...
		this.forniture.add("Bed");
		this.forniture.add("TV");
	}

	public Room(double width, double length, double height, int numDoors, int numWindows, String name) {
		this.width = width;
		this.height = height;
		this.length = length;
	...
	public Room(double width, double length, double height, int numDoors, int numWindows, String name, ArrayList<String> forniture) {
		this(width,  length, height, numDoors, numWindows, name);
